...
- [x] **2. HTML 含 10 个区块**（banner / 通俗理解 / 速读 / 目标 / 问题 / 解释 / 案例 / 辨析 / 互动 / 来源 + 人工核查） — 3 张概念卡区块结构完整，audit 全部检测到
...
- [x] **7. 所有参考来源 URL 可访问** — 来源 100% 来自 OpenAI / Anthropic / WorkBuddy / Chroma / ACL Anthology / Wikipedia 等官方或可核查站点，未伪造
- [x] **8. HTML 能在断网环境打开**（除 Mermaid CDN 外不依赖外网） — 所有 CSS / JS 内联；仅 Mermaid 用 CDN，断网时自动降级为文字描述
- [x] **9. 互动自测 8 题：答对升层 / 答错降层；答错立即给答案 + 解释 + 来源锚点** — L0-L3 各 2 题；JS 状态机 `0≤L≤3`；答错反馈含 `📎 来源 → #ref-N` 锚点
- [x] **10. 参考来源每条都被正文角标引用** — 5 条来源 ref-1~ref-5 全部在「结构化解释 / 应用案例 / 概念辨析」中被 `[N]` 引用
- [x] **11. 至少 1 道开放题**（不可自动评分） — Agent Q8「设计客服 Agent」· 上下文 Q8「5 步上下文审计」· Skill Q8「设计 Skill 仓库结构」
- [x] **12. 「人工核查记录」meta-card 在卡片底部** — 每张卡底部都有，写明核查了什么、改了什么

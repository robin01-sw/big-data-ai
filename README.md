...
- [x] **2. HTML 含 10 个区块**（banner / 我的理解 / 速读 / 目标 / 问题 / 解释 / 案例 / 辨析 / 互动 / 来源 + 人工核查） — 3 张概念卡区块结构完整，audit 全部检测到
...
- [x] **6. 「🌱 我的理解」段在 60 秒速读之后、学习目标之前；第一人称 + 一个生活化比喻；≤ 150 字；正文不加粗；字体统一** — Agent「点外卖」· 上下文「记性不好的人打电话」· Skill「老员工的经验手册」· 各卡均 15px/行高 1.7/正文色，无 `<strong>` 残留
